# Infra Audit — Extended Reference

> This file contains verbose actionable examples, testing patterns, edge cases, and anti-patterns externalized from `SKILL.md` to keep the main skill under 5KB. See [SKILL.md](../../../.agents/skills/infra-audit/SKILL.md) for the core scan dimensions, checklist, and risk scoring.
