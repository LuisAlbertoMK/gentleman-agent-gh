# project-mapper — Worked Examples & Guardrails

> **Externalized from** .agents/skills/project-mapper/SKILL.md to keep the skill under the 3KB
> token budget (ADR-007). Contains worked examples, testing patterns, edge cases, anti-patterns,
> engram integration protocol, and quick reference card.
> **Consumable by**: project-mapper sub-agent when producing a project map.
