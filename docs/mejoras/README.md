...
| 2026-07-31 | [`skill-usage-audit`](2026-07-31-skill-ecosystem-audit.md) | Skills | Uso real (DB 716 sessions): 3 skills muertas, runtime `skill` roto por misconfig (plugin lazy-loader `skill/` vs `skills/`), 3 refs STALE skill-creator, 1 solape real. | 🏁 active (plan) |
...
| 2026-07-28 | [`tdd-testing`](2026-07-28-tdd-testing-analysis.md) | Testing | 7 findings — validate-write-scope tests (26), close-session tests (43), restore/forge-rollback tests (18), strict_tdd, pre-commit hook, CodeCoverage, Mock. | ✅ 7/7 completed |
...
| 2026-08-19 | [`gentleman-agent-gh-analisis-08-19`](2026-08-19-async-delegation-analysis.md) | Delegación | Mini-orchestrator async delegation — analysis report | 📄 Disponible |
...
| 2026-08-12 | [`gentleman-agent-gh-analisis-08-12`](2026-08-12-v3-update-docs-stale.md) | Multi-dimension | Análisis v3 actualización 08-12 | 📄 Disponible |
...
| 2026-08-08 | [`gentleman-agent-gh-analisis-08-08`](2026-08-08-auto-agent-autonomy-delegation.md) | Multi-dimension | Autonomía agentes auto — auto-decisión paths | 📄 Disponible |
...
| 2026-08-07 | [`gentleman-agent-gh-analisis-08-07`](2026-08-07-v3-baseline-34-gaps.md) | Multi-dimension | Análisis v3 — baseline general del proyecto | 📄 Disponible |
