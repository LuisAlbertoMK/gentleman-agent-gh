...
4. **[LOW] Convención ADR** — `docs/adr/` no existía; la convención del repo es `adr/ADR-NNN-*` (next libre: 021). El brief mandata `docs/adr/008-...`; número 008 colisiona con `adr/ADR-008-whitespace-normalization.md`. Ver Nuance del completion report.
