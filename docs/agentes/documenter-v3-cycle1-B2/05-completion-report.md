## Decision Taken
Ciclo #1 v3 (Enfoque B2) cerrado: cycle log, ADR-024 (H2, Proposed) y append a mejora-log escritos; H2 verificado como HIGH latente; benchmark FAIL atribuido a Gap D.

## Files Changed
- docs/mejoras/2026-08-07-v3-cycle1-B2.md (nuevo, 7,209 B) — cycle log
- adr/ADR-024-auto-sub-permission-merge-safety.md (nuevo, 3,346 B) — ADR Proposed
...
5. [LOW] docs/adr/ no existía; convención repo = adr/ADR-NNN-* (próximo libre 021); brief mandata adr/ADR-024-* — número colisiona con adr/ADR-008-whitespace-normalization.md.
