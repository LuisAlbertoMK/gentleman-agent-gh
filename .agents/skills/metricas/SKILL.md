...
---
On-demand before/after comparison w/ % improvement. Trigger: "metricas", "métricas", "comparar", "mejora", "delta", "token", "tokenizar".
## Flow

1. Capture baseline (before) → 2. Apply change → 3. Capture (after) → 4. Display: **Before | After | Δ | Δ%** (green↑ red↓ — if 0)
## Two modes
| Mode | Usage |
|------|-------|
