...
**LLM**: `grep -rn "openai\|anthropic\|ollama\|langchain" --include="*.{ts,js,py}"` → verify user input not injected into prompts without sanitization
## OUTPUT FORMAT
```
## Security Scan: {scope}
### Summary
