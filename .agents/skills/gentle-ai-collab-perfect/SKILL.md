...
triggers: "gentle-ai, external collaborator, issue-first, PR body, chained PR, stacked PR, contribution flow, contributor scope, verification protocol, docstring coverage"
license: Apache-2.0
metadata:
  author: ardelperal
  version: "0.1"
