...
Colección de **53 skills profesionales** para OpenCode AI agent. Diseñadas para desarrollo de software con arquitectura limpia, TDD real, y principios SR Engineer.
...
**Total: 53 skills + _shared** — todas con SKILL.md, frontmatter YAML y licencia Apache-2.0.
