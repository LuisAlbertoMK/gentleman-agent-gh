...
Suite of **92 skills** (+ `_shared`) + **126 top-level scripts** (119 PowerShell + 7 shell) for [OpenCode](https://github.com/sst/opencode). Designed for software development with clean architecture, TDD, and multi-layer verification.
...
├── scripts/                 # 126 top-level scripts (119 PowerShell + 7 shell)
│   └── smoke/               # Smoke tests
├── docs/                    # Documentation
