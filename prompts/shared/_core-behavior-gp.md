...
GP RETURN FORMAT: see _return-contract.md (4-field: Decision Taken, Files Changed, Key Findings, Nuance)

> Extended rules (PEV, Budget, Confidence, Tools, trial-verify): see _core-behavior-extended.md"
