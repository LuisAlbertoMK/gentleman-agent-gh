...
$sharedScripts = @(
    ...
    @{Src=Join-Path "scripts" "wisdom-core.ps1";Dst=Join-Path "scripts" "wisdom-core.ps1"},
    @{Src=Join-Path "scripts" "wisdom-maintenance.ps1";Dst=Join-Path "scripts" "wisdom-maintenance.ps1"},
