...
Describe "Score Depth Regression Guard" {
    ...
    It "Score Depth dimension is 10.0 (historical 9.2 regression guard)" {
        # $proj.score.dimensions.'Score Depth' | Should -Be 10.0
        $script:proj.score.dimensions.'Score Depth' | Should -Be 10.0
    }
    ...
    It "SD score (s) is 10.0" {
        # $proj.dimensions_detail.SD.s | Should -Be 10.0
        $script:proj.dimensions_detail.SD.s | Should -Be 10.0
    }
}
